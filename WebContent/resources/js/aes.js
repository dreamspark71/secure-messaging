...
/**
AES 256 bit encryption algorithm implementation
Short Notes:
        Nr = 10,12,14 for 128,192 an 256 bit respectively
        w = key schedule as 2D byte-array i.e byte[][] used for addRoundKey 
        Nb = number of columns(column size)
             for AES it is always fixed to 4 
...
class Aes 
{
    ...
    static cipher(input, w) 
    {
        ...
        let state = [ [], [], [], [] ];  // initialising 4×Nb byte-array 'state'
        ...
        const output = new Array(4*Nb);  // converting state to 1-d array 
